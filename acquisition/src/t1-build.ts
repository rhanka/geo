...
/** Deposit a freshly derived T1 geometry only with the bytes of its real plan. */
export async function depositT1ServedZoneGeojson(
  s3: S3Client,
  key: string,
...
async function main(): Promise<void> {
  ...
  if (args.dryRun) {
    ...
    await depositT1ServedZoneGeojson(
      s3,
      s3Key,
