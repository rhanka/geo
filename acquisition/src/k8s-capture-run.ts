      ...
      containers:
        - name: capture
          ...
          resources:
            ...
            limits:
              cpu: 500m
              # 29.5 MiB est le plus gros règlement observé ; 13 × 29.5 MiB
              # donne 383.5 MiB, arrondi au Mi supérieur pour le runtime Node
              # et les buffers de transport, sans choisir 512 Mi par défaut.
              memory: 384Mi
          securityContext:
