/**
 * _zones-vnatif-record-md-geocentralis-lotB-20260810.ts — génère le record .md LOT-B
 * géoCentralis à partir du record .json machine (jamais reformater la sortie à la main).
 *
 * USAGE :
 *   npx tsx acquisition/src/_zones-vnatif-record-md-geocentralis-lotB-20260810.ts \
 *     --in work/coverage/zones-vnatif-deposit-record-geocentralis-lotB-20260810.json \
 *     --out work/coverage/zones-vnatif-deposit-record-geocentralis-lotB-20260810.md
 */
...
function main(): void {
  ...
  const md = `# Dépôt zones — LOT-B géoCentralis WFS — 2026-08-10
...
pilote (\`05de001a\`/\`cd363a04\`) + lot-A (\`656eb46d\`). **${rec.summary.deposited} DÉPÔTS EFFECTUÉS**,
...
Worklist : \`work/coverage/zones-vnatif-capture-worklist-geocentralis-lotB-20260810.json\` (${rec.summary.total} munis).
...
Lot-B géoCentralis **CLÔTURÉ : ${rec.summary.deposited}/${rec.summary.total} DÉPOSÉS, ${rec.summary.skipped} SKIP** (gardes légitimes). Chemin WFS → preuve v2
