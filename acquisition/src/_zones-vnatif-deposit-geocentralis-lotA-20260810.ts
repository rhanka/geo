/**
 * _zones-vnatif-deposit-geocentralis-lotA-20260810.ts — DÉPÔT v2 candidate/legacy-traceable
 * → documented du LOT-A géoCentralis WFS (~40 munis, 2 couches partagées), grain zone-polygon.
 *
 * Réplique EXACTE de la recette pilote (05de001a/cd363a04) à l'échelle. Source =
 * geoserver.geocentralis.com/geoserver/ows, GetFeature outputFormat=application/json filtré
 * par CQL_FILTER=id_municipalite=<id>, DÉJÀ CAPTURÉ sur le cluster (run 20260810T150000Z).
 *
 ...
 *   npx tsx acquisition/src/_zones-vnatif-deposit-geocentralis-lotA-20260810.ts \
 *     [--commit] [--only <slug>] --out work/coverage/zones-vnatif-deposit-record-geocentralis-lotA-20260810.json
 */
...
const RUN_STAMP = "20260810T150000Z";
const GRAIN: GeometryGrain = "zone-polygon";
const OVERLAP_MIN_PCT = 90;
const DEFAULT_WORKLIST = "work/coverage/zones-vnatif-capture-worklist-geocentralis-lotA-20260810.json";
...
async function main(): Promise<void> {
  ...
  const record = {
    contract: "zones-vnatif-deposit-record-geocentralis-lotA/v1",
    date: "2026-08-10",
    ...
    decision: "CLEAN-UPGRADE lot-A géoCentralis WFS (legacy-traceable→documented v2), source-identity WFS, zone_code brut du champ-code (réplique pilote 05de001a/cd363a04)",
