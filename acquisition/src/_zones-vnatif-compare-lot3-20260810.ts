/**
 * _zones-vnatif-compare-lot3-20260810.ts — SONDE DIAGNOSTIC (lecture seule).
 *
 * Variante lot3 de _zones-vnatif-compare-lot2-20260810.ts. Pour chaque ville du
 * manifeste lot3, compare le jeu de CODES DE ZONE canoniques de la collection
 * SERVIE (S3, layout plat + sous-dossier) au jeu de codes de la couche AMONT
 * capturée (octets CAS, zone_field du manifeste). Produit l'évidence exacte du
 * gate identité (`depositCapturedZones`) : combien de codes servis sont absents
 * de la capture (uncovered → gate HELD), et la provenance servie (level +
 * zone_source_url). N'écrit RIEN sur S3.
 *
 * USAGE :
 *   NODE_OPTIONS=--dns-result-order=ipv4first AWS_MAX_ATTEMPTS=10 \
 *   npx tsx acquisition/src/_zones-vnatif-compare-lot3-20260810.ts
 */
