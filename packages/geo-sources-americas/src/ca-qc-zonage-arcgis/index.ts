...
export const SUPPLEMENTAL_ZONAGE_ARCGIS_ENDPOINTS: readonly VerifiedArcgisZonageEndpoint[] = [
  ...
  {
    citySlug: "temiscouata-zonage-municipal",
    serviceUrl: "https://services.arcgis.com/aaWqU4clL4fblaWE/arcgis/rest/services/Zonage_MRC_T%C3%A9miscouata_vue/FeatureServer/0",
    zoneCodeField: "ZONE",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Zonage municipal", owner: "MRC de Témiscouata", layerName: "Zonage municipal vue", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "abitibi-affectations-sadr",
    serviceUrl: "https://services1.arcgis.com/wyvhRSHkhCSY7ojh/arcgis/rest/services/Grandes_affectations_du_territoire_SADR/FeatureServer/101",
    zoneCodeField: "Descrip_gen",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Grandes affectations du territoire SADR", owner: "MRC Abitibi", layerName: "Grandes affectations du territoire SADR", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "cote-de-gaspe-affectation-industrielle",
    serviceUrl: "https://services3.arcgis.com/8Q74mlssYfOLESBc/arcgis/rest/services/Affectations_territoire/FeatureServer/0",
    zoneCodeField: "NOM_C1",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Affectation industrielle", owner: "MRC de La Côte-de-Gaspé", layerName: "Affectation industrielle", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "cote-de-gaspe-affectation-urbaine",
    serviceUrl: "https://services3.arcgis.com/8Q74mlssYfOLESBc/arcgis/rest/services/Affectations_territoire/FeatureServer/1",
    zoneCodeField: "NOM_C1",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Affectation urbaine", owner: "MRC de La Côte-de-Gaspé", layerName: "Affectation urbaine", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "cote-de-gaspe-affectation-recreative",
    serviceUrl: "https://services3.arcgis.com/8Q74mlssYfOLESBc/arcgis/rest/services/Affectations_territoire/FeatureServer/2",
    zoneCodeField: "NOM_C1",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Affectation récréative", owner: "MRC de La Côte-de-Gaspé", layerName: "Affectation récréative", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "cote-de-gaspe-affectation-rurale",
    serviceUrl: "https://services3.arcgis.com/8Q74mlssYfOLESBc/arcgis/rest/services/Affectations_territoire/FeatureServer/3",
    zoneCodeField: "NOM_C1",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Affectation rurale", owner: "MRC de La Côte-de-Gaspé", layerName: "Affectation rurale", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "cote-de-gaspe-affectation-forestiere",
    serviceUrl: "https://services3.arcgis.com/8Q74mlssYfOLESBc/arcgis/rest/services/Affectations_territoire/FeatureServer/4",
    zoneCodeField: "NOM_C1",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Affectation forestière", owner: "MRC de La Côte-de-Gaspé", layerName: "Affectation forestière", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "val-saint-francois-grande-affectation",
    serviceUrl: "https://services8.arcgis.com/RT1BkiMAAZM2yTCt/arcgis/rest/services/Intranet_SAD_Revision/FeatureServer/1",
    zoneCodeField: "LETTRE",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Grande affectation", owner: "MRC Val-Saint-François", layerName: "Grande affectation", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "argenteuil-zonage",
    serviceUrl: "https://services9.arcgis.com/iZcAwIV2GibwcZLe/arcgis/rest/services/Zonage/FeatureServer/0",
    zoneCodeField: "zone",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Zonage", owner: "MRC d'Argenteuil", layerName: "Zonage", geometryType: "esriGeometryPolygon" },
  },
  {
    citySlug: "vallee-du-richelieu-affectations",
    serviceUrl: "https://services8.arcgis.com/jryHBP52Ub6tFsaW/arcgis/rest/services/Affectations/FeatureServer/0",
    zoneCodeField: "aff_id",
    verifiedAt: "2026-06-18T00:00:00.000Z",
    source: "manual-demo-unverified-arcgis",
    rightsProfile: "demo-unverified",
    meta: { title: "Grandes affectations", owner: "MRC de La Vallée-du-Richelieu", layerName: "Affectations", geometryType: "esriGeometryPolygon" },
  },
