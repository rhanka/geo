/**
 * Unit tests for the PURE rotation-disambiguation decisions (decideRotation +
 ...
 * `acquisition/src/lib/t2-rotation-disambig.test.ts`.
 */
import { describe, it, expect } from "vitest";

import { decideAnisoArbitration, decideRotation, type MeasuredRotation } from "./rotation-disambig.js";
