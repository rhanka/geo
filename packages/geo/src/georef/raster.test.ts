/**
 * Unit tests for the pure raster image helpers (georef/raster.ts).
 *
 * Pure, network-free. Ported verbatim (import path only) from the acquisition
 * golden test `acquisition/src/lib/t2-raster-register.test.ts`.
 */
import { describe, expect, it } from "vitest";

import { detectRasterCorners, edgeMaskFromGray, parsePgm, patchEdgeScore, type GrayImage } from "./raster.js";
