/**
 * georef/raster.ts — pure raster-image helpers for T2 raster registration.
 *
 * Ported from the acquisition recalage pipeline
 * (`acquisition/src/lib/t2-raster-register.ts`). This module intentionally
 * contains only deterministic in-memory image compute: PGM parsing, edge masks,
 * corner detection and local edge-patch scoring. PDF rendering (`pdftoppm`),
 * cadastre loading and GCP-file emission stay in the acquisition app layer.
 */
