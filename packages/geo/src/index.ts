 ...
 * the OGC API – Features server, and the `geo` CLI into a single Node-only
 * package (ADR-0017). Sub-path entry points (`@sentropic/geo/acquire`,
 * `@sentropic/geo/storage`, …) expose each subsystem; this root barrel
