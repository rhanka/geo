...
Répartition : recale_ok=6, recale_missing=149, unresolved=1, deja_v2_servi=11, hors_scope=0.
Exception : aucune.

Recalcul : `npx tsx acquisition/src/zones-recalage-status-run.ts --out=work/coverage/zones-recalage-status-167-20260802T192614Z.json --markdown=work/coverage/zones-recalage-status-167-20260802T192614Z.md`.
