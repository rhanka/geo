...
──────────────────────────   ───────────────   ───────────────────────────────────────────
global                       3181/4975 (64%)   3181 items faits; poursuivre les WP ouverts
...
───────────────────────────────────   ───────────────   ────────────────────────────────────────────────────────────────────────
WP3 · couche: zones                   766/1106 (69%)    zones/agol-account · abercorn [to-research] — Zonage via compte AGOL /
...
WP4 · couche: normes                  556/1106 (50%)    normes/pdf-native · abercorn [to-research] — Normes — grille extraite du
                                                        PDF natif (texte/tableau) / normes/pdf-native · adstock [to-research] —
                                                        Normes — grille extraite du PDF natif (texte/tableau) (+548 autres)

WP5 · couche: pv                      1045/1106 (94%)   pv/scraper-configured · baie-sainte-catherine [to-research] — PV —
...
WP9 · immo-lots-enrichment            810/1634 (50%)    immo-lots surface_m2 · aguanish — surface_m2 present on 100% of served
                                                        lots / immo-lots surface_m2 · caniapiscau — surface_m2 present on 100%
                                                        of served lots (+822 autres)
...
spec-not-ready   immo-lots surface_m2 · aguanish — surface_m2 present on 100% of served     action (subagent): spécifier avant de démarrer
                 lots
...
spec-not-ready   immo-lots code_postal · boucherville — code_postal present on 100% of      action (subagent): spécifier avant de démarrer
                 served lots
