# Palier 20×167 — rescan S3 post-Boisbriand — 2026-08-10T03:36:40Z
...
obtenu est horodaté `2026-08-10T03:36:01.265Z` : `pv=1064`, `normes=815`,
`zones=911`, `cadastre=1106`, `role-foncier=1106`, `tod=39` (tous `+0`). La
matrice lot→zone a ensuite été régénérée sur cette couverture, avant la
génération Palier et son contrôle `--check`.
...
Aucun KPI ne bouge. Le reçu Boisbriand est une capture ArcGIS brute/CAS
