...
| `saint-amable` | 0 | `RX-122`: `null → null`, donc `inconnu`, de `712-00-2013/2013` à `712-47-2026/2026`. L'entrée ne sert aucun delta: les deux grilles indiquent verbatim l'absence de valeur à « Nombre de logements (minimum/maximum) ». Le fold et l'API OGC publique retournent les deux compteurs `null` et `effet_densifiant=inconnu`. |
